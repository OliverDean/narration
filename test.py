...
# Initialize the TTS model (multi-speaker)
tts = TTS(model_name="tts_models/en/vctk/vits")

# Pick one valid speaker ID (e.g. "p225")
speaker_id = "p300"
print("Available speakers:", tts.speakers)

# Read text from 'test.txt' (must exist in the same directory)
with open("test.txt", "r", encoding="utf-8") as f:
    text_data = f.read()

# Generate and save the audio to "test.wav"
tts.tts_to_file(
    text=text_data,
    speaker=speaker_id,
    file_path="test.wav"
...
print("Available speakers:", tts.speakers)
print("Audio file 'test.wav' created successfully!")
